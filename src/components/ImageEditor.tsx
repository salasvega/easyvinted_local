                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-700 text-sm leading-relaxed">
                        Décrivez les modifications que vous souhaitez apporter à la photo et Studio Magik-AI s'occupe du le réaliser. Il peut remplacer l'arrière-plan (fond blanc studio, béton gris, bois clair), améliorer la luminosité, centrer le produit, placer le vêtement à plat ou le plier... 
