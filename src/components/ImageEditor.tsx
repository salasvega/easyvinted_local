                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-700 text-sm leading-relaxed">
                        Décrivez les modifications que vous souhaitez apporter à votre article et laissez Studio Magik-AI les réaliser. Il peut remplacer l'arrière-plan (fond blanc studio, béton gris, bois clair...), améliorer la luminosité, centrer le produit, placer le vêtement à plat ou le plier si vous etes mauuvais (si-si)! Si vous êtes trop moche demandez à notre assistant de le faire porter en situation par un modèle de votre choix! En bref, Laissez vous guider par votre créativité, notre seule limite est votre imagination! 
                      </p>
                    </div>
                    <button
